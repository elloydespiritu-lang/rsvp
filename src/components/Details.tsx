...
export default function Details() {
  return (
    <section className="py-24 md:py-32 bg-[#F7F4EF] text-ink relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 mb-32">
          {/* Ceremony */}
          <motion.div 
            className="flex flex-col items-center text-center p-10 md:p-14 border border-maroon/10 rounded-[2rem] bg-white shadow-[0_10px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(107,30,30,0.08)] transition-all duration-700 relative overflow-hidden group"
