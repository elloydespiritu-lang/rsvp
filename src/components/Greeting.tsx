        ...
        >
          ...
          <div className="mt-16 relative group">
            ...
            <img 
              ...
              alt="Lloyd and Nicole" 
              className="w-full h-64 md:h-96 object-cover object-[38%_65%] md:object-center rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.08)] relative z-10 transform group-hover:-translate-y-1 transition-all duration-700 ease-out"
