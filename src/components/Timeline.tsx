  ...
  const events = [
    {
      title: "First Meeting",
      date: "August 14, 2021",
      description: "We met at a coffee shop. What was supposed to be a quick coffee turned into a 4-hour conversation.",
    ...
    },
    {
      ...
      description: "Under the twinkling lights, Elloyd got down on one knee and asked the easiest question Nicole ever had to answer.",
  ...
  return (
    <section className="py-24 md:py-32 bg-white text-ink relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h2 className="font-serif text-5xl md:text-6xl mb-4 text-maroon">Our Story</h2>
            ...
            {events.map((event, index) => {
              ...
              return (
                <div key={index} className={`flex flex-col md:flex-row items-center justify-between ${isEven ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  >
                    <div className="aspect-[4/3] overflow-hidden rounded-2xl shadow-lg border border-gold/10">
                      <img 
                        src={event.image} 
                        alt={event.title} 
                  ...
                  >
                    ...
                    <h3 className="font-serif text-3xl md:text-4xl text-maroon mb-4 italic">
                      {event.title}
                    </h3>
