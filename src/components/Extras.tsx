    ...
    <section className="px-6 relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Dress Code */}
          <motion.div 
            className="invitation-card flex flex-col items-center w-full"
          ...
          >
            ...
            <p className="font-sans text-ink-soft text-lg leading-relaxed mb-12 max-w-2xl font-light tracking-wide">
            ...
            <div className="flex gap-8 justify-center flex-wrap">
              <div className="flex flex-col items-center gap-3 group">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-ink-soft/80">Deep Maroon</span>
              </div>
              <div className="flex flex-col items-center gap-3 group">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-ink-soft/80">Burgundy</span>
              </div>
              <div className="flex flex-col items-center gap-3 group">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-ink-soft/80">Classic Red</span>
              </div>
              <div className="flex flex-col items-center gap-3 group">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-ink-soft/80">Blush Pink</span>
              </div>
              <div className="flex flex-col items-center gap-3 group">
                ...
                <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-ink-soft/80">Soft Rose Nude</span>
              </div>
            </div>
          </motion.div>
